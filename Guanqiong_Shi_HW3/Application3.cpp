...
#define INFILE3  "pot4.asc"		// tri.asc
#define OUTFILE3 "pot4.ppm"		// tri.ppm

//#define INFILE3  "tri.asc"		// tri.asc
//#define OUTFILE3 "tri.ppm"		// tri.ppm
